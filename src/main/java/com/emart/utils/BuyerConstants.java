...
public class BuyerConstants {
	...
	public static final List<String> baseURLs = new ArrayList<>(List.of("http://35.193.126.223:8081/", "http://34.121.47.153:8081/",
			"http://34.69.90.201:8081/", "http://34.125.75.24:8081/"));
